...
useEffect(() => {
    ...
    if (slugLang !== language) {
      ...
      const newPath = language === 'EN' ? '/en/our-services' : '/hizmetlerimiz';
  ...
  const handleBack = () => {
    navigate(language === "EN" ? "/en/our-services" : "/hizmetlerimiz");
  };

  if (loading) return <LoadingSpinner text={t("loadingService")} />;
  if (!post) return <NotFound text={t("serviceNotFound")} link="/hizmetlerimiz" linkText={t("backToAllServices")} />;
    ...
    <>
      ...
      <main className="pt-20 max-w-6xl mx-auto px-6 pb-16">
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-4xl mx-auto">
          ...
          <div
            className="service-content max-w-none text-gray-700"
            dangerouslySetInnerHTML={{ __html: post.content }}
          />

          <BackButton onClick={handleBack} text={t("backToAllServices")} />
