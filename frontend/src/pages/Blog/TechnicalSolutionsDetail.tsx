...
export default function TechnicalSolutionDetail() {
    ...
    useEffect(() => {
        ...
        if (slugLang !== language) {
            ...
            const newPath = language === 'EN' ? '/en/technical-solutions' : '/teknik-cozumler';
    ...
    const handleBack = () => {
        navigate(language === "EN" ? "/en/technical-solutions" : "/teknik-cozumler");
    };
            ...
            <main className="bg-gray-50 min-h-screen">
                <div className="max-w-4xl mx-auto py-20 px-6 text-center">
                    ...
                    <p className="text-gray-600 mb-8">
                        {error || (language === "EN" ? "The technical solution you're looking for doesn't exist." : "Aradığınız teknik çözüm mevcut değil.")}
                    </p>
                    <button
                        onClick={handleBack}
                    ...
                    >
                        ...
                        {language === "EN" ? "Back to Solutions" : "Çözümlere Dön"}
                    </button>
                </div>
            </main>
        );
            ...
            <main className="bg-gray-50 min-h-screen">
                ...
                <section className="bg-gradient-to-br from-green-600 via-teal-700 to-blue-700 text-white py-16 px-6">
                    <div className="max-w-4xl mx-auto">
                        ...
                        >
                            <ArrowLeft className="w-4 h-4" />
                            {language === "EN" ? "Back to Technical Solutions" : "Teknik Çözümlere Dön"}
                        </button>
                        <div className="flex items-start gap-3 mb-4">
                            <Settings className="w-8 h-8 text-green-300 flex-shrink-0 mt-1" />
                ...
                <section className="max-w-4xl mx-auto py-16 px-4 sm:px-6 md:px-8">
                    ...
                    <div className="mt-12 text-center">
                        ...
                        >
                            <ArrowLeft className="w-4 h-4" />
                            {language === "EN" ? "Back to All Solutions" : "Tüm Çözümlere Dön"}
                        </button>
                    </div>
                </section>
            </main>
